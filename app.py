...
def get_keyword_trends():
    ...
    try:
        ...
        # تهيئة قياسية بسيطة لتفادي مشاكل البناء على Render
        pytrends = TrendReq(hl='ar-SA', tz=180, timeout=(10, 25), requests_args={'headers': headers})
        pytrends.build_payload([keyword], cat=0, timeframe='today 12-m', geo='SA', gprop='')
        
        # استخدام COUNTRY لجلب التوزيع على مستوى المناطق الإدارية
